'''
En esta versión implementaremos un menú para que el usuario pueda elegir entre:
-Login
-Crear usuario
-Eliminar usuario

Luego de que logee podrá operar normalmente
...
while True:
    ...
    print("Bienvenido/a, ingrese a su cuenta o cree una si no la tiene:\n")
    print("Opciones:\n\n(1)Ingresar\n(2)Crear usuario\n(3)Eliminar usuario\n")
...
while True:
    ...
    #######################
    saldo = actualizar_saldo(usuario_actual, tipo, monto) # Eliminaremos la variable en la siguiente version, dejando solo la llamada a la funcion
    # No es necesaria una variable si dentro del bucle se está ejecutando la funcion en forma de bucle y trabajando sobre el diccionario
