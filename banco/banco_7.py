'''
El menú funciona, pero limpiaremos el código y le mejoraremos alguans cosas:

    -Que cuando el usuario elija "fin" se deslogee y le de las opciones de login, crear o eliminar usuario. Agregaremos "Salir" para cerrar el programa.

    -Crear la funcion "menú" del punto anterior.
...
# Funcion para operar cuando logea        
def operar():
    while True:
        ...
        while True:
            ...
            actualizar_saldo(usuario_actual, tipo, monto) 
            numero_operacion += 1 
